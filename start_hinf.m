...
P = h8care(A,B,C2cap,D2cap,Ecap,gamma);
Q=h8care(A',C1',Ecap',D1cap',C2cap',gamma);
...
K=-(Q*C1'+Ecap*D1')*inv((D1*D1'));
Acmp=A+(1/gamma^2)*E*E'*P+B*F+(eye(11)-(1/gamma^2)*Q*P)^-1*K*(C1+(1/gamma^2)*D1*Ecap'*P);
Bcmp=-(eye(11)-(1/gamma^2)*Q*P)^-1*K;
Ccmp=F;